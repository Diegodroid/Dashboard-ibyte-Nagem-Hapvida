...
df_NAGEM['ESTADO'] = df_NAGEM['LOCAL'].str[-2:]
df_NAGEM['CIDADE'] = df_NAGEM['LOCAL'].str.extract(r'([^\-]+)')

# Unique values for filters
cidades = ['Todos'] + list(df_NAGEM['CIDADE'].unique())
estados = ['Todos'] + list(df_NAGEM['ESTADO'].unique())
status_options = ['Todos'] + list(df_NAGEM['STATUS'].unique())
categoria_options = ['Todos'] + list(df_NAGEM['CATEGORIA'].unique())
...
max_size = df_NAGEM['DESCRICAO'].str.len().max()
